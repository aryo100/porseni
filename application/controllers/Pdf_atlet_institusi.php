...
Class Pdf_atlet_institusi extends CI_Controller{
    ...
    function index(){
        ...
        $pdf->Cell(50,10,'Cabang Olahraga',1,0);
        $pdf->Cell(10,10,'Perguruan Tinggi',1,0);
        $pdf->Cell(10,10,'Email',1,0);
        $pdf->Cell(10,10,'No. Telp',1,0);
        $pdf->Cell(10,10,'Status',1,0);
        $pdf->SetFont('Arial','',10);
        $sql=$this->db->query("SELECT* FROM atlet where '$pt'");
        $atlet = $sql->result();
