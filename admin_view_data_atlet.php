						...
						<tr>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a class="red" href="javascript:if(confirm('Apakah Anda yakin ingin unapprove anggota ini ?')){document.location='<?php echo base_url();?>index.php/institusi/atlet_unapprove/<?php echo $obj1->id_atlet;?>';}">
